...
export function BottomNav() {
  ...
  return (
    <nav className="safe-bottom sticky bottom-0 z-40 mt-auto border-t border-border/80 bg-card/95 px-2 pt-1 shadow-[0_-10px_30px_rgba(18,63,50,0.08)] backdrop-blur">
