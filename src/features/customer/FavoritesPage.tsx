...
function FavoritesPage() {
  ...
  return (
    <div className="phone-frame min-h-screen bg-background pb-20 text-foreground">
      <header className="border-b border-border bg-card px-5 pb-5 safe-top" dir="rtl"><div className="flex items-center justify-between"><div><h1 className="font-display text-2xl font-black">المفضلة</h1><p className="mt-1 text-xs font-bold text-muted-foreground">العروض اللي عينك عليها عشان ما تطير.</p></div><span className="rounded-full bg-secondary px-3 py-1 text-xs font-black text-primary">{saved.length}</span></div></header>
